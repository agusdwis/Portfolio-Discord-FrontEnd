...
export default function Chats () {
    return(
        <React.Fragment>
            ...
            <section className="title-3qD0b- container-1r6BKw themed-ANHk51" aria-label="Channel header">
                <div className="children-19S4PO">
                    <div className="iconWrapper-2OrFZ1 focusable-1YV_-H" role="button" aria-label="Text Channel" tabIndex="-1">
                    ...
                    <h3 role="button" className="title-29uC1r base-1x0h_U size16-1P40sf">minecraft</h3>
                    <div className="divider-3FBTu8"/>
                    <div className="topic-TCb_qw expandable-9fI_e3" role="button" tabIndex="0">For all things Minecraft! Please Keep
                        It Minecraft.
                    </div>
                </div>
                <div className="toolbar-1t6TWx">
                    <div className="iconWrapper-2OrFZ1 clickable-3rdHwn focusable-1YV_-H" role="switch"
                         aria-label="Mute channel minecraft" aria-checked="false" tabIndex="0">
                    ...
                    <div className="iconWrapper-2OrFZ1 clickable-3rdHwn focusable-1YV_-H" role="button" aria-label="Pinned Messages"
                         tabIndex="0">
                        <svg width="24" height="24" viewBox="0 0 24 24">
                            <foreignObject x="0" y="0" width="24" height="24" mask="url(#svg-mask-header-bar-badge)">
                                <svg x="0" y="0" className="icon-22AiRD" aria-hidden="false" width="24" height="24"
                                     viewBox="0 0 24 24">
                        ...
                        <span className="iconBadge-qZ4Ksk"/></div>
                    <div className="iconWrapper-2OrFZ1 clickable-3rdHwn selected-1GqIat focusable-1YV_-H" role="button"
                         aria-label="Member List" tabIndex="0">
                        <svg x="0" y="0" className="icon-22AiRD" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="currentColor" fillRule="evenodd" clipRule="evenodd"
                    ...
                    <div className="search-36MZv-">
                        <div className="search-2oPWTC">
                            <div className="searchBar-3dMhjb" role="combobox" aria-label="Search" aria-owns="search-results"
                                 aria-expanded="false">
                                <div className="DraftEditor-root">
                                    <div className="public-DraftEditorPlaceholder-root">
                                        <div className="public-DraftEditorPlaceholder-inner" id="placeholder-650i"
                                             style={{whiteSpace: 'pre-wrap'}}>Search
                                        </div>
                                    </div>
                                    <div className="DraftEditor-editorContainer">
                                        <div aria-describedby="placeholder-650i" className="notranslate public-DraftEditor-content"
                                            ...
                                            <div data-contents="true">
                                                <div className="" data-block="true" data-editor="650i" data-offset-key="bcl4j-0-0">
                                                    <div data-offset-key="bcl4j-0-0"
                                                         className="public-DraftStyleDefault-block public-DraftStyleDefault-ltr">
                                                        <span data-offset-key="bcl4j-0-0"><br data-text="true"/></span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="icon-38sknP iconLayout-1WxHy4 small-1lPjda" tabIndex="-1" role="button">
                                    <div className="iconContainer-O4O2CN">
                                        <svg className="icon-3cZ1F_ visible-3V0mGj" aria-hidden="false" width="18" height="18"
                                             viewBox="0 0 18 18">
                                        ...
                                        <svg aria-hidden="false" className="icon-3cZ1F_" width="12" height="12" viewBox="0 0 12 12">
                                            <g fill="none" fillRule="evenodd" aria-hidden="true">
                                                <path d="M0 0h12v12H0"/>
                                                <path className="fill" fill="currentColor" d="M9.5 3.205L8.795 2.5 6 5.295 3.205 2.5l-.705.705L5.295 6 2.5 8.795l.705.705L6 6.705 8.795 9.5l.705-.705L6.705 6"/>
                                            </g>
                                        </svg>
                                    </div>
                                </div>
                    ...
                    <div className="iconWrapper-2OrFZ1 clickable-3rdHwn focusable-1YV_-H" role="button" aria-label="Recent Mentions"
                         tabIndex="0">
                        <svg x="0" y="0" className="icon-22AiRD" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <a tabIndex="-1" className="anchor-3Z-8Bb anchorUnderlineOnHover-2ESHQB" href="https://support.discord.com"
                       rel="noreferrer noopener" target="_blank">
                        <div className="iconWrapper-2OrFZ1 clickable-3rdHwn focusable-1YV_-H" role="button" aria-label="Help"
                             tabIndex="0">
                            <svg x="0" y="0" className="icon-22AiRD" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
